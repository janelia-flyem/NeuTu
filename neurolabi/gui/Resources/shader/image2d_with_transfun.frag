...
#else
  voxel1 = texture2D(volume_struct_1.volume, texCoord0);
#endif
...
#else
  voxel2 = texture2D(volume_struct_2.volume, texCoord0);
#endif
...
#else
  voxel3 = texture2D(volume_struct_3.volume, texCoord0);
#endif
...
#else
  voxel4 = texture2D(volume_struct_4.volume, texCoord0);
#endif
...
#else
  voxel5 = texture2D(volume_struct_5.volume, texCoord0);
#endif
