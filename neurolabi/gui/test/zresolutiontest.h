...
TEST(ZResolution, Basic)
{
  ...
  ASSERT_DOUBLE_EQ(
        1.0, resolution.getVoxelSize(NeuTube::X_AXIS, ZResolution::UNIT_PIXEL));
  ASSERT_DOUBLE_EQ(
        2.0, resolution.getVoxelSize(NeuTube::Y_AXIS, ZResolution::UNIT_PIXEL));
  ASSERT_DOUBLE_EQ(
        3.0, resolution.getVoxelSize(NeuTube::Z_AXIS, ZResolution::UNIT_PIXEL));

  ASSERT_DOUBLE_EQ(
        1.0, resolution.getVoxelSize(NeuTube::X_AXIS, ZResolution::UNIT_MICRON));
  ASSERT_DOUBLE_EQ(
        2.0, resolution.getVoxelSize(NeuTube::Y_AXIS, ZResolution::UNIT_MICRON));
  ASSERT_DOUBLE_EQ(
        3.0, resolution.getVoxelSize(NeuTube::Z_AXIS, ZResolution::UNIT_MICRON));
  ...
  ASSERT_DOUBLE_EQ(
        1000.0, resolution.getVoxelSize(NeuTube::X_AXIS, ZResolution::UNIT_NANOMETER));
  ASSERT_DOUBLE_EQ(
        2000.0, resolution.getVoxelSize(NeuTube::Y_AXIS, ZResolution::UNIT_NANOMETER));
  ASSERT_DOUBLE_EQ(
        3000.0, resolution.getVoxelSize(NeuTube::Z_AXIS, ZResolution::UNIT_NANOMETER));
