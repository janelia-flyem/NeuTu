...
ZKeyEventSwcMapper::ZKeyEventSwcMapper()
{
  initKeyMap();
}
...
void ZKeyEventSwcMapper::initKeyMap()
{
  ...
  m_plainKeyMap[Qt::Key_Comma] = ZSwcTree::OPERATION_DEDREASE_NODE_SIZE;
  m_plainKeyMap[Qt::Key_Q] = ZSwcTree::OPERATION_DEDREASE_NODE_SIZE;
  m_plainKeyMap[Qt::Key_Period] = ZSwcTree::OPERATION_INCREASE_NODE_SIZE;
  m_plainKeyMap[Qt::Key_E] = ZSwcTree::OPERATION_DEDREASE_NODE_SIZE;
