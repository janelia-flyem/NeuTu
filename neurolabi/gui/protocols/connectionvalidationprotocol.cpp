...
{
  HLDEBUG("protocol") << "Construct ConnectionValidationProtocol" << std::endl;
  ui->setupUi(this);
...
bool ConnectionValidationProtocol::initialize() {
  HLDEBUG("protocol") << "Initialize ConnectionValidationProtocol" << std::endl;
