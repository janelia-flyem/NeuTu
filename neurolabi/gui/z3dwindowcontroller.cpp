...
{
  window->setLayerVisible(neutube3d::ERendererLayer::MESH, on);
}

void Z3DWindowController::ToggleMeshVisible(Z3DWindow *window)
{
  window->setLayerVisible(neutube3d::ERendererLayer::MESH,
                          !window->isLayerVisible(neutube3d::ERendererLayer::MESH));
}
