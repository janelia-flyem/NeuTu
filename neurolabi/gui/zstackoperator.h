...
public:
  ...
  enum EOperation {
    ...
    OP_ZOOM_TO,
    OP_PAINT_STROKE, OP_START_PAINT_STROKE,
    OP_START_MOVE_IMAGE, /*OP_SHOW_STACK_CONTEXT_MENU,*/
    ...
    OP_SWC_INCREASE_NODE_SIZE_FAST, OP_SWC_DECREASE_NODE_SIZE_FAST,
    ...
    OP_SWC_SELECT_CONNECTION, OP_SWC_SELECT_NODE_IN_ROI,
    OP_SWC_SELECT_FLOOD, OP_SWC_SELECT_TREE_IN_ROI,
    OP_SWC_SELECT_TERMINAL_BRANCH_IN_ROI,
    OP_SWC_CONNECT_TO,
    ...
    OP_ACTIVE_STROKE_ESTIMATE_SIZE, OP_ACTIVE_STROKE_CHANGE_LABEL,
    ...
    OP_FLYEM_SPLIT_BODY_LOCAL, OP_FLYEM_SPLIT_BODY,
