...
public:
  ...
  enum EAction {
    ...
    ACTION_BODY_CHANGE_COLOR, ACTION_BODY_RESET_COLOR,
    ACTION_BODY_SPLIT_START, ACTION_ADD_SPLIT_SEED,
    ACTION_BODY_MERGE, ACTION_BODY_UNMERGE,
    ACTION_BODY_ANNOTATION, ACTION_BODY_ANNOTATION_BATCH,
    ACTION_BODY_CHECKIN, ACTION_BODY_CHECKOUT,
    ...
    ACTION_MERGE_LINK_ACTIVATE,
    ACTION_MERGE_LINK_CLEAR,
    ACTION_MERGE_LINK_CLEAR_ALL,
    ACTION_MERGE_LINK_SELECT_BODIES,
    ACTION_MERGE_LINK_SELECT_BODIES_EXC,
    ACTION_BOOKMARK_CHECK, ACTION_BOOKMARK_UNCHECK, ACTION_BOOKMARK_SELECT_BODY,
...
//    ACTION_SHOW_ORTHO, ACTION_SHOW_ORTHO_BIG,
    ACTION_VIEW_LAYOUT_3, ACTION_VIEW_LAYOUT_2, ACTION_VIEW_LAYOUT_1,
    ...
    ACTION_CHECK_TODO_ITEM, ACTION_CHECK_WONTFIX_TODO_ITEM, ACTION_ACTIVATE_TODO_ITEM,
    ...
    ACTION_COPY_NEUROGLANCER_LINK_AT_RECT_ROI,
    ...
    ACTION_BODY_COLOR_SEQUENCER_NORMAL, ACTION_BODY_COLOR_RANDOM,
    ...
    ACTION_VIEW_AXIS_X, ACTION_VIEW_AXIS_Y, ACTION_VIEW_AXIS_Z,
    ACTION_VIEW_AXIS_ARB,
    ACTION_USER_FEEDBACK, ACTION_PROFILE,
    ACTION_SEPARATOR
  };
...
*/
  ...
  EAction getActionKey(QAction *action) const;

private:
  QUndoStack *m_undoStack = NULL;
  mutable QMap<QAction*, EAction> m_actionMap;
};
