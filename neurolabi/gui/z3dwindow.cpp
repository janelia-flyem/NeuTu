...
{
  std::cout << "Eye: " << getCamera()->get().eye() - m_cameraRecord.getEye()
            << std::endl;
  std::cout << "Center: "
            << getCamera()->get().center() - m_cameraRecord.getCenter() << std::endl;
  std::cout << "Up vector: "
            << getCamera()->get().upVector() - m_cameraRecord.getUpVector() << std::endl;
}
