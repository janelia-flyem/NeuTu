...
void Z3DSurfaceFilter::setData(const ZPointNetwork &pointNetwork,
...
void Z3DSurfaceFilter::addData(const Z3DGraph &graph)
{
...
void Z3DSurfaceFilter::setData(const Z3DGraph &graph)
{
  m_graph = graph;
  m_dataIsInvalid = true;
  invalidateResult();
...
void Z3DSurfaceFilter::setData(const ZObject3d &obj)
{
