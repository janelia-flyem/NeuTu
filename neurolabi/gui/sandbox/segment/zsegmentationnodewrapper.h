...
public:
  ZSegmentationNodeWrapper(shared_ptr<ZSegmentationTree> tree, const string& node_id):m_tree(tree),m_id(node_id){}
...
public:
  ...
  virtual void display(ZPainter &painter, int slice, EDisplayStyle option, neutube::EAxis sliceAxis) const;
